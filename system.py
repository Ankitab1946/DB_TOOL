...
def context(request: Request):
    ...
    return {
        ...
        "server": server,
        "main_schema": str(cfg.get("schema") or "prj_dbd") if db_type == "POSTGRES" else "dbo",
        "staging_schema": "prj_stage" if db_type == "POSTGRES" else "stg",
        "database_enabled": cfg["enabled"],
        "database_auth_mode": cfg.get("auth_mode") if db_type == "POSTGRES" else None,
        "current_user": user,
        "role": role,
        "is_admin": role == "ADMIN",
    }
